...
<PageTransition>
      ...
      <section className="properties-intro">
        ...
        <div className="container">
          ...
          <p>
            From CDA sectors and DHA Islamabad to Bahria Town,
            Capital Smart City, Gulberg, Park View City,
            PHA Flats and every major housing society,
            we provide honest advice, verified properties,
            transparent dealings and complete documentation support.
          </p>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <p>
                Residential plots, luxury homes,
                apartments, commercial plots and offices.
              </p>
            ...
            <div className="service-card">
              ...
              <p>
                Professional marketing with genuine buyers and
            ...
            <div className="service-card">
              ...
              <p>
                Complete legal verification, file checking and
            ...
            <div className="service-card">
              ...
              <p>
                Secure property purchase, documentation
                and investment consultancy from abroad.
              </p>
